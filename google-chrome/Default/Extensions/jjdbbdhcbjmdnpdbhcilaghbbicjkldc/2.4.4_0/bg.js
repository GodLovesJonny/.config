...
function(t, e) {
    ...
    w = function(t, e) {
        return localStorage["stop-proxy"] && "true" == localStorage["stop-proxy"] ? (s.off("", "隧道已暂停"), void chrome.proxy.settings.set({
            value: {
                mode: "system"
            },
            scope: "regular"
    ...
    a.get(function() {
        ...
        n.R(function() {
            ...
            function(t) {
                ...
                o.off("!", '错误<a target="_blank" href="/warming.html">请</a>重启浏览器');
